...
const DEFAULT_PAGES = [
    ...
    { name: '读书与考试 Part 1', url: 'dushu-part-1.html', type: 'page', keywords: 'dushu p2 part 1 reading quiz vocab 生词 读书与考试 studying exams crq' },
    { name: '读书与考试 Part 2', url: 'dushu-part-2.html', type: 'page', keywords: 'dushu p3 part 2 reading quiz vocab 生词 读书与考试 studying exams crq' },
    { name: '读书与考试 All Vocab', url: 'dushu-vocab.html', type: 'page', keywords: 'dushu p2 p3 cumulative combined vocab 生词 读书与考试 studying exams review' },
