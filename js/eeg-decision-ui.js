(() => {
  ...
  function FactorBar({ factor }) {
    ...
    return /* @__PURE__ */ k("div", { style: { margin: "3px 0" } }, /* @__PURE__ */ k("div", { style: { display: "flex", justifyContent: "space-between", fontSize: "10px" } }, /* @__PURE__ */ k("span", { style: { color: "#888" } }, factor.label), /* @__PURE__ */ k("span", { style: { color: factor.color } }, factor.value < 0 ? "\u2212" : "+", Math.abs(factor.value).toFixed(2))), /* @__PURE__ */ k("div", { style: { height: "4px", background: "rgba(255,255,255,0.06)", borderRadius: "2px", margin: "1px 0" } }, /* @__PURE__ */ k("div", { style: { width: `${pct}%`, height: "100%", background: factor.color, borderRadius: "2px" } })));
  }
  function EegDecisionView({ title, charLabel, statsLabel, totalScore, factors, fragile, eegSummary, runners, handSize }) {
    return /* @__PURE__ */ k("div", null, /* @__PURE__ */ k("div", { style: { fontWeight: 700, fontSize: "12px", color: "#9575cd", marginBottom: "6px" } }, title), /* @__PURE__ */ k("div", { style: { fontSize: "18px", fontWeight: 600, margin: "4px 0" } }, charLabel), statsLabel ? /* @__PURE__ */ k("div", { style: { fontSize: "10px", color: "#777", marginBottom: "4px" } }, statsLabel) : null, /* @__PURE__ */ k("div", { style: { fontSize: "14px", fontWeight: 700, color: "#e0e0e0", margin: "4px 0 8px" } }, totalScore.toFixed(2), " ", /* @__PURE__ */ k("span", { style: { fontSize: "10px", color: "#666", fontWeight: 400 } }, "score")), factors.map((factor) => /* @__PURE__ */ k(FactorBar, { key: factor.label, factor })), fragile ? /* @__PURE__ */ k("div", { style: { fontSize: "9px", color: "#ffb74d", marginTop: "2px" } }, "\u26A0 Fragile") : null, eegSummary ? /* @__PURE__ */ k("div", { style: { marginTop: "8px", padding: "6px", background: "rgba(149,117,205,0.08)", borderRadius: "5px", fontSize: "10px" } }, "Focus ", /* @__PURE__ */ k("b", { style: { color: "#4fc3f7" } }, eegSummary.focus, "%"), " \xB7 Calm ", /* @__PURE__ */ k("b", { style: { color: "#9575cd" } }, eegSummary.calm, "%"), eegSummary.mlLabel ? /* @__PURE__ */ k(Fragment, null, " \xB7 ML: ", /* @__PURE__ */ k("b", null, eegSummary.mlLabel)) : null, !eegSummary.signalOk ? /* @__PURE__ */ k("div", { style: { color: "#ef5350", marginTop: "2px" } }, "\u26A0 Poor signal") : null) : null, runners.length ? /* @__PURE__ */ k("div", { style: { marginTop: "10px", borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: "6px" } }, /* @__PURE__ */ k("div", { style: { fontSize: "9px", color: "#666", marginBottom: "4px" } }, "Also considered (", handSize, " in hand)"), runners.map((runner) => /* @__PURE__ */ k("div", { key: runner.label, style: { display: "flex", justifyContent: "space-between", fontSize: "10px", padding: "2px 0", color: "#888" } }, /* @__PURE__ */ k("span", null, runner.label), /* @__PURE__ */ k("span", null, runner.score.toFixed(1))))) : null);
  }
  function render(container, props) {
    if (!container) return;
    R(/* @__PURE__ */ k(EegDecisionView, { ...props }), container);
  }
