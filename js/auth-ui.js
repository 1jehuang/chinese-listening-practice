(() => {
  ...
  function AuthButton({ isSignedIn, isAnonymous, avatarUrl, email, onSignIn, onSignOut }) {
    if (isSignedIn && !isAnonymous) {
      return /* @__PURE__ */ k(
        ...
        avatarUrl ? /* @__PURE__ */ k("img", { id: "auth-avatar", className: "w-8 h-8 rounded-full", alt: "Profile", src: avatarUrl }) : /* @__PURE__ */ k("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" }, /* @__PURE__ */ k("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" }))
      );
    }
    return /* @__PURE__ */ k(
      "button",
      ...
      /* @__PURE__ */ k("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" }, /* @__PURE__ */ k("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" }))
    );
  }
  function AuthContainer({ inSidebar, isSignedIn, isAnonymous, avatarUrl, email, onSignIn, onSignOut }) {
    ...
    return /* @__PURE__ */ k("div", { id: "auth-container", className: containerClass }, /* @__PURE__ */ k(
      AuthButton,
      {
        isSignedIn,
        isAnonymous,
  ...
  function render(container, props) {
    if (!container) return;
    R(/* @__PURE__ */ k(AuthContainer, { ...props }), container);
  }
