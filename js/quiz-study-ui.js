(() => {
  ...
  function q(n2, u3, t3, i3, r3, o2, e3, f3, c3, s3) {
    var a3, h2, p2, v3, y3, d3, _2, k3, x2, M, $2, I2, P2, A3, H2, T2 = u3.type;
    ...
    n: if ("function" == typeof T2) try {
      ...
      h2.state = h2.__s, null != h2.getChildContext && (i3 = m(m({}, i3), h2.getChildContext())), x2 && !p2 && null != h2.getSnapshotBeforeUpdate && (d3 = h2.getSnapshotBeforeUpdate(v3, y3)), A3 = null != a3 && a3.type === S && null == a3.key ? E(a3.props.children) : a3, f3 = L(n2, g(A3) ? A3 : [A3], u3, t3, i3, r3, o2, e3, f3, c3, s3), h2.base = u3.__e, u3.__u &= -161, h2.__h.length && e3.push(h2), _2 && (h2.__E = h2.__ = null);
    } catch (n3) {
  ...
  function StudyRow({ char, pinyin, meaning, marking, audioButtonHtml, onMark }) {
    return /* @__PURE__ */ k("div", { className: "study-list-row flex items-center gap-2 px-2 py-1 rounded-lg border border-transparent hover:border-gray-200 hover:bg-gray-50 transition" }, /* @__PURE__ */ k("div", { className: "md:col-span-2 font-semibold text-gray-900 truncate min-w-[2rem] text-center text-lg" }, char), /* @__PURE__ */ k("div", { className: "md:col-span-3 text-sm text-gray-600 truncate min-w-0 max-w-[120px]" }, pinyin), /* @__PURE__ */ k("div", { className: "md:col-span-6 text-xs text-gray-500 truncate flex-1 min-w-0" }, meaning), /* @__PURE__ */ k("div", { className: "md:col-span-1 shrink-0 flex items-center gap-1 justify-end" }, audioButtonHtml ? /* @__PURE__ */ k("span", { dangerouslySetInnerHTML: { __html: audioButtonHtml } }) : null, /* @__PURE__ */ k(
      "button",
      {
        type: "button",
        className: `text-sm px-1.5 py-0.5 rounded border transition ${marking === "learned" ? "border-emerald-400 text-emerald-600 bg-emerald-50" : marking === "needs-work" ? "border-amber-400 text-amber-600 bg-amber-50" : "border-gray-200 text-gray-400 hover:border-gray-400"}`,
        onClick: () => onMark(char)
      },
  ...
  function StudyModeView({
    ...
    return /* @__PURE__ */ k("div", { className: "study-mode-shell h-full flex flex-col gap-4 overflow-hidden" }, /* @__PURE__ */ k("div", { className: "flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between px-4 lg:px-6" }, /* @__PURE__ */ k("div", null, /* @__PURE__ */ k("h2", { className: "text-2xl font-semibold text-gray-900" }, title || "Study Mode Reference"), /* @__PURE__ */ k("p", { className: "text-sm text-gray-600" }, subtitle || "Quick list of this lesson's vocab. Use search or sorting as needed.")), /* @__PURE__ */ k("div", { id: "studyStatsFiltered", className: "text-sm text-gray-500" }, "Showing ", filteredCount || 0, " / ", totalCount || 0, " terms")), /* @__PURE__ */ k("div", { className: "study-body grid grid-cols-1 gap-4 px-4 lg:px-6 flex-1 min-h-0 overflow-y-auto" }, /* @__PURE__ */ k("div", { className: "study-list-card flex flex-col gap-3 min-h-0" }, /* @__PURE__ */ k("div", { className: "flex flex-col gap-3 md:flex-row md:items-center md:gap-4" }, /* @__PURE__ */ k("div", { className: "relative flex-1 w-full" }, /* @__PURE__ */ k("span", { className: "absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-base pointer-events-none" }, "\u2315"), /* @__PURE__ */ k(
      "input",
      {
        id: "studySearchInput",
        type: "search",
        ...
        autocomplete: "off",
        value: searchValue || "",
        onInput: (e3) => onSearchChange == null ? void 0 : onSearchChange(e3.currentTarget.value)
      }
    )), /* @__PURE__ */ k("div", { className: "flex flex-wrap gap-3 items-center text-sm md:justify-end" }, /* @__PURE__ */ k("label", { htmlFor: "studyFilterSelect", className: "font-semibold text-gray-600" }, "Filter:"), /* @__PURE__ */ k(
      "select",
      {
        ...
        onChange: (e3) => onFilterChange == null ? void 0 : onFilterChange(e3.currentTarget.value)
      },
      /* @__PURE__ */ k("option", { value: "all" }, "All words"),
      /* @__PURE__ */ k("option", { value: "needs-work" }, "\u26A0 Needs work"),
      /* @__PURE__ */ k("option", { value: "learned" }, "\u2713 Learned")
    ), /* @__PURE__ */ k("label", { htmlFor: "studySortSelect", className: "font-semibold text-gray-600" }, "Sort:"), /* @__PURE__ */ k(
      "select",
      {
        id: "studySortSelect",
        className: "px-4 py-2 rounded-xl border border-gray-300 focus:border-blue-500 focus:outline-none text-sm font-semibold text-gray-700 bg-white",
        value: sortValue || "original",
        onChange: (e3) => onSortChange == null ? void 0 : onSortChange(e3.currentTarget.value)
      },
      /* @__PURE__ */ k("option", { value: "original" }, "Original order"),
      /* @__PURE__ */ k("option", { value: "char" }, "Character (A-Z)"),
      /* @__PURE__ */ k("option", { value: "pinyin" }, "Pinyin (A-Z)"),
      /* @__PURE__ */ k("option", { value: "meaning" }, "Meaning (A-Z)")
    ), /* @__PURE__ */ k("button", { id: "studyShuffleBtn", type: "button", className: "px-4 py-2 rounded-xl border border-gray-300 text-sm font-semibold text-gray-700 hover:border-blue-500 hover:text-blue-600 transition bg-white", onClick: onShuffle }, "Shuffle"), /* @__PURE__ */ k("button", { id: "studyResetBtn", type: "button", className: "px-4 py-2 rounded-xl border border-gray-300 text-sm font-semibold text-gray-700 hover:border-blue-500 transition bg-white", onClick: onReset }, "Reset"))), /* @__PURE__ */ k("div", { className: "rounded-2xl border border-gray-200 bg-white shadow-sm flex-1 min-h-0 flex flex-col" }, /* @__PURE__ */ k("div", { className: "hidden md:grid grid-cols-12 gap-4 px-4 py-2 text-xs font-semibold tracking-wide text-gray-500 uppercase bg-gray-50 rounded-t-2xl" }, /* @__PURE__ */ k("span", { className: "md:col-span-2" }, "Character"), /* @__PURE__ */ k("span", { className: "md:col-span-3" }, "Pinyin"), /* @__PURE__ */ k("span", { className: "md:col-span-6" }, "Meaning"), /* @__PURE__ */ k("span", { className: "md:col-span-1 text-right" }, "Audio")), /* @__PURE__ */ k("div", { id: "studyList", className: "study-list flex-1 min-h-0 overflow-y-auto divide-y divide-gray-100" }, items && items.length > 0 ? items.map((item) => /* @__PURE__ */ k(
      StudyRow,
      {
        key: item.char,
        char: item.char,
    ...
    )) : /* @__PURE__ */ k("div", { className: "text-xs text-gray-500 py-4 text-center" }, emptyMessage || "No items to study"))))));
  }
  function render(container, props) {
    if (!container) return;
    R(/* @__PURE__ */ k(StudyModeView, { ...props }), container);
  }
