(() => {
  ...
  function App({ config, prompts, currentIndex, completed, answer, meaningVisible, feedback, onAnswerChange, onCheck, onToggleMeaning, onPrev, onNext, onRandom, onReplay, replayEnabled }) {
    ...
    return /* @__PURE__ */ k("div", { className: "bg-gray-100 min-h-screen p-4 md:p-8" }, /* @__PURE__ */ k("a", { href: "home.html", className: "fixed top-4 left-4 bg-white hover:bg-gray-100 text-gray-700 px-3 py-2 rounded-lg shadow border border-gray-200 transition text-sm" }, "\u2190 Home"), /* @__PURE__ */ k("div", { className: "max-w-4xl mx-auto mt-16 md:mt-0 bg-white rounded-xl shadow-lg p-6 md:p-8" }, /* @__PURE__ */ k("h1", { className: "text-3xl font-bold text-center mb-3 text-gray-800" }, "Sentence Meaning Drill"), /* @__PURE__ */ k("p", { className: "text-gray-600 text-center mb-6" }, "Listen to the sentence, read along, then explain the whole sentence in English before revealing the suggested answer."), /* @__PURE__ */ k("div", { className: "bg-gray-50 border border-gray-200 rounded-xl p-6 md:p-8" }, /* @__PURE__ */ k("div", { className: "flex flex-wrap items-center justify-between gap-3 mb-4" }, /* @__PURE__ */ k("span", { className: "text-sm uppercase tracking-widest text-gray-400" }, item ? `${currentIndex + 1} / ${prompts.length}` : "Loading\u2026"), /* @__PURE__ */ k(
      "button",
      {
        type: "button",
    ...
    )), !replayEnabled ? /* @__PURE__ */ k("div", { className: "text-sm text-yellow-600 mb-4 text-center" }, "Your browser does not support speech synthesis; rely on the on-screen sentence.") : null, /* @__PURE__ */ k("div", { className: "text-2xl leading-relaxed text-center text-gray-900 mb-6" }, (item == null ? void 0 : item.sentence) || "Loading prompts\u2026"), /* @__PURE__ */ k("div", { className: "text-center text-lg text-gray-700 mb-6" }, "\u{1F449} ", /* @__PURE__ */ k("span", { className: "font-semibold text-gray-900" }, (item == null ? void 0 : item.prompt) || "Explain the sentence meaning.")), /* @__PURE__ */ k("div", { className: "space-y-3 mb-6" }, /* @__PURE__ */ k("label", { htmlFor: "answerInput", className: "block text-sm font-medium text-gray-600" }, "Type your full-sentence interpretation (optional):"), /* @__PURE__ */ k(
      "textarea",
      {
        id: "answerInput",
        ref: inputRef,
      ...
      "Check answer"
    )), /* @__PURE__ */ k("div", { className: `mt-4 text-center text-lg font-semibold ${(feedback == null ? void 0 : feedback.status) === true ? "text-green-600" : (feedback == null ? void 0 : feedback.status) === false ? "text-red-600" : "text-gray-600"}` }, (feedback == null ? void 0 : feedback.message) || ""), /* @__PURE__ */ k("div", { className: "flex flex-col items-center gap-3 mt-6" }, /* @__PURE__ */ k(
      "button",
      {
        type: "button",
  ...
  function SentenceDrillApp() {
    ...
    y2(() => {
      ...
      return () => cancelSpeech();
    }, [currentItem == null ? void 0 : currentItem.sentence]);
    y2(() => {
  ...
  var root = document.getElementById("sentenceDrillApp");
  if (root) {
    R(/* @__PURE__ */ k(SentenceDrillApp, null), root);
  }
