(() => {
  ...
  function SentenceModeView({
    ...
    ))), difficultyDescription ? /* @__PURE__ */ k("div", { className: "sentence-mode-description" }, difficultyDescription) : null) : null), /* @__PURE__ */ k("div", { className: "sentence-mode-card sentence-mode-card--sentence" }, /* @__PURE__ */ k("div", { className: "sentence-mode-subtitle" }, subtitle), /* @__PURE__ */ k("div", { className: "sentence-mode-sentence" }, sentence)), /* @__PURE__ */ k("div", { className: "sentence-mode-card sentence-mode-card--prompt" }, /* @__PURE__ */ k("div", { className: "sentence-mode-prompt" }, "\u{1F449} ", prompt), /* @__PURE__ */ k("div", { className: "sentence-mode-helper" }, helperText)));
  }
