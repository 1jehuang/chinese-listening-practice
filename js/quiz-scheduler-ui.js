(() => {
  ...
  function SchedulerToolbarView({
    ...
    return /* @__PURE__ */ k("div", { id: "schedulerToolbar", className: "mb-2 flex flex-col items-center gap-1" }, modeLabel ? /* @__PURE__ */ k("div", { id: "schedulerModeLabel", dangerouslySetInnerHTML: { __html: modeLabel } }) : null, modeDescription ? /* @__PURE__ */ k("div", { id: "schedulerModeDescription", dangerouslySetInnerHTML: { __html: modeDescription } }) : null, /* @__PURE__ */ k(StatusLine, { id: "batchModeStatus", html: batchStatus }), /* @__PURE__ */ k(StatusLine, { id: "adaptiveModeStatus", html: adaptiveStatus }), /* @__PURE__ */ k(StatusLine, { id: "composerModeStatus", html: composerStatus }), /* @__PURE__ */ k(StatusLine, { id: "feedModeStatus", html: feedStatus }), /* @__PURE__ */ k("div", { className: "flex flex-wrap gap-1 justify-center items-center max-w-full px-1" }, (buttons || []).map((btn) => /* @__PURE__ */ k(
      SchedulerButton,
      {
        key: btn.id,
        id: btn.id,
  ...
  function render(container, props) {
    if (!container) return;
    R(/* @__PURE__ */ k(SchedulerToolbarView, { ...props }), container);
  }
