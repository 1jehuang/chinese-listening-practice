(() => {
  ...
  function UsageHint({ hint }) {
    if (!(hint == null ? void 0 : hint.label) || !hint.before && !hint.after) return null;
    return /* @__PURE__ */ k("div", { className: "word-usage-hint" }, /* @__PURE__ */ k("div", { className: "word-usage-hint-kicker" }, "Usage pattern", hint.category ? ` \xB7 ${hint.category}` : ""), /* @__PURE__ */ k("div", { className: "word-usage-hint-example" }, hint.before ? /* @__PURE__ */ k("span", null, hint.before, " ") : null, /* @__PURE__ */ k("span", { className: "word-usage-hint-pill" }, "[", hint.label, "]"), hint.after ? /* @__PURE__ */ k("span", null, " ", hint.after) : null));
  }
