(() => {
  ...
  function Toast({ message, visible, type }) {
    ...
    return /* @__PURE__ */ k("div", { className: classes.join(" ") }, message);
  }
  function FeedbackPanel({ type, message, detail, onContinue, showContinue }) {
    ...
    return /* @__PURE__ */ k("div", { className: classes.join(" ") }, /* @__PURE__ */ k("div", { className: "feedback-message" }, message), detail ? /* @__PURE__ */ k("div", { className: "feedback-detail" }, detail) : null, showContinue ? /* @__PURE__ */ k("button", { type: "button", className: "feedback-continue-btn", onClick: onContinue }, "Continue") : null);
  }
  function HintPanel({ char, pinyin, meaning, perCharHtml }) {
    return /* @__PURE__ */ k("div", { id: "hint", className: "hint-panel" }, /* @__PURE__ */ k("div", { className: "text-sm text-gray-500 mt-2" }, /* @__PURE__ */ k("strong", null, "Chinese:"), " ", char, " (", pinyin, ")", /* @__PURE__ */ k("br", null), /* @__PURE__ */ k("strong", null, "Reference:"), " ", meaning), perCharHtml ? /* @__PURE__ */ k("div", { dangerouslySetInnerHTML: { __html: perCharHtml } }) : null);
  }
  function TimerDisplay({ timeStr, colorClass }) {
    return /* @__PURE__ */ k("div", { className: "timer-display" }, /* @__PURE__ */ k("span", { className: colorClass || "" }, "\u23F1 ", timeStr));
  }
  function GradeBanner({ letterGrade, gradeColor, bgColor, borderColor, pct, summaryHtml }) {
    return /* @__PURE__ */ k(
      ...
      /* @__PURE__ */ k("span", { style: { color: gradeColor, fontWeight: 700, fontSize: "1rem" } }, letterGrade),
      /* @__PURE__ */ k("span", { style: { color: gradeColor, fontWeight: 600 } }, pct, "%"),
      summaryHtml ? /* @__PURE__ */ k("span", { dangerouslySetInnerHTML: { __html: summaryHtml } }) : null
    );
  }
  function QuizFeedbackView({
    ...
    return /* @__PURE__ */ k(S, null, toast ? /* @__PURE__ */ k(Toast, { ...toast }) : null, feedback ? /* @__PURE__ */ k(FeedbackPanel, { ...feedback, onContinue }) : null, hint ? /* @__PURE__ */ k(HintPanel, { ...hint }) : null, timer ? /* @__PURE__ */ k(TimerDisplay, { ...timer }) : null, gradeBanner ? /* @__PURE__ */ k(GradeBanner, { ...gradeBanner }) : null);
  }
  function render(container, props) {
    if (!container) return;
    R(/* @__PURE__ */ k(QuizFeedbackView, { ...props }), container);
  }
