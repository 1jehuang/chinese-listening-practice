(() => {
  ...
  function CharPinyinOption({ option, highlighted, onSelect }) {
    ...
    return /* @__PURE__ */ k(
      ...
      /* @__PURE__ */ k("span", { className: "quiz-char-pinyin-choice-char" }, option.char),
      /* @__PURE__ */ k("span", { className: "quiz-char-pinyin-choice-meta" }, /* @__PURE__ */ k("span", { className: "quiz-char-pinyin-choice-pinyin" }, option.pinyinDisplay || option.pinyin))
    );
  }
  function FuzzyModeView({
    ...
    return /* @__PURE__ */ k("div", { id: "fuzzyMode", style: { display: "block" } }, /* @__PURE__ */ k("div", { className: "fuzzy-input-row" }, /* @__PURE__ */ k(
      "input",
      {
        ref: inputRef,
        id: "fuzzyInput",
        ...
        onKeyDown: (e3) => {
          ...
          if (onKeyDown) onKeyDown(e3);
        }
      }
    )), /* @__PURE__ */ k("div", { id: "fuzzyOptions", className: "flex flex-col gap-2 mt-2" }, options.map((option, index) => /* @__PURE__ */ k(
      OptionComponent,
      {
  ...
  function render(container, props) {
    if (!container) return;
    R(/* @__PURE__ */ k(FuzzyModeView, { ...props }), container);
  }
