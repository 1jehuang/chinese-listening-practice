(() => {
  ...
  function PaletteItem({ item, index, selected, onSelect, getTypeMeta, getActionLabel, getDefaultDescription }) {
    ...
    return /* @__PURE__ */ k(
      ...
      /* @__PURE__ */ k("div", { className: "flex-1 min-w-0" }, /* @__PURE__ */ k("div", { className: "flex items-center gap-2 mb-1" }, /* @__PURE__ */ k("div", { className: "font-semibold text-gray-900 text-base" }, item.name), /* @__PURE__ */ k("span", { className: `inline-flex items-center text-xs font-semibold px-2 py-0.5 rounded border ${typeMeta.className}` }, typeMeta.text), item.scope ? /* @__PURE__ */ k("span", { className: "inline-flex items-center text-[11px] font-semibold px-2 py-0.5 rounded border bg-amber-50 text-amber-700 border-amber-200" }, item.scope) : null), /* @__PURE__ */ k("div", { className: "text-sm text-gray-600 leading-relaxed" }, description)),
      /* @__PURE__ */ k("div", { className: "flex items-center gap-2 flex-shrink-0" }, item.shortcut ? /* @__PURE__ */ k("span", { className: "inline-flex items-center gap-1 text-xs font-mono font-semibold text-gray-600 bg-gray-100 border border-gray-300 rounded px-2 py-1 ml-2" }, item.shortcut) : null, /* @__PURE__ */ k("span", { className: "text-xs font-medium text-gray-400 uppercase tracking-wide" }, getActionLabel(item)))
    );
  }
  function CommandPaletteView({ visible, query, searchPlaceholder, items, selectedIndex, onQueryChange, onKeyDown, onSelect, onBackdrop, getTypeMeta, getActionLabel, getDefaultDescription }) {
    return /* @__PURE__ */ k(
      ...
      /* @__PURE__ */ k("div", { className: "bg-white rounded-xl shadow-2xl w-full max-w-2xl mx-4 overflow-hidden border border-gray-100" }, /* @__PURE__ */ k("div", { className: "px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white" }, /* @__PURE__ */ k(
        "input",
        {
          type: "text",
          id: "paletteSearch",
      ...
      )), /* @__PURE__ */ k("div", { id: "paletteResults", className: "max-h-96 overflow-y-auto" }, items.length ? items.map((item, index) => /* @__PURE__ */ k(
        PaletteItem,
        {
      ...
      )) : /* @__PURE__ */ k("div", { className: "px-6 py-8 text-center text-gray-500" }, "No commands match \u201C", query.trim(), "\u201D.")))
    );
  }
  function render(container, props) {
    if (!container) return;
    R(/* @__PURE__ */ k(CommandPaletteView, { ...props }), container);
  }
